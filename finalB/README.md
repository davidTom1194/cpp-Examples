# finalB
This programming assignment is an demonstration of the skills learned with C++ that will calculate a student's grade,
their average scores, the classes average score, and determine who had the highest and lowest grades based on their
their respective scores that are stored in a data file.

Notable features include:
  - proper code documentation
  - appropriate global constants
  - structs
  - functions
  - input verification
  - file streams
...
# File descriptions
- Grade Report: finalB.cpp

- Test Files:
    - finalB-data0.txt (student names and scores)

## Getting Started

Clone/download the files and any dependencies for your project then compile and run the programs using the linux command:
  - "$ c++ $CXXFLAGS finalB.cpp -o finalB"
  - "$ echo finalB-data0.txt | ./finalB"
