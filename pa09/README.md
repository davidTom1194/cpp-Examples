# pa09
This programming assignment is an demonstration of the skills learned with C++ that will calculate a student's grade and GPA
based on their respective scores that are stored in a .csv file.
...
- Test Files:
    - pa09-data0.csv (student names and scores)
