# pa18
The programming assignment will implement and analyze various integer expressions to process infix expressions and convert to postfix notation to then compute its value.
